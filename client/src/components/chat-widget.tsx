                            ...
                            <>
                              ...
                              {message.sender === 'bot' && hasWhatsAppInfo(message.text) && (
                                <button
                                  ...
                                  className="mt-3 inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20B954] text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg animate-pulse"
                                >
                                  <svg 
                                    className="w-4 h-4" 
                                    viewBox="0 0 24 24" 
