...
export default function Header() {
  ...
  return (
    <header className="w-full z-50 px-4 sm:px-6 lg:px-8 py-4 mt-8 relative">
      ...
      {/* Mobile Navigation */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 z-40 bg-[#0a0a0a]/98 backdrop-blur-md">
          <div className="flex flex-col items-center justify-center h-full px-8 space-y-8">
            {/* Navigation Links */}
            <div className="flex flex-col items-center space-y-8">
              <button 
                onClick={() => scrollToSection("agentes")} 
                className="text-white/90 hover:text-[#1E90FF] transition-colors duration-300 font-medium text-2xl"
              >
                Agentes
              </button>
              <button 
